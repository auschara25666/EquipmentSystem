                ...
                <div class="col-9 mx-auto">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse-17" class="collapse" role="tabpanel" aria-labelledby="heading-17" data-parent="#accordion-6">
                                        <div class="card-body">
                                            <h4>
                                                <ol class="pl-3 mt-4">
                                                    <li>กรอกรหัสประจำตัวนักศึกษาที่มี - เช่น <span class="badge badge-warning">UserID: 60xxxxxx-x</span></li>
                            ...
                            <form class="form-sample" action="Config/save_register-std.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="lname" required="required" class="form-control" placeholder="สอนดี" pattern="[^'\0-9]+[^-,]" title="กรุณากรอกนามสกุลให้ถูกต้อง" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="user_id" required="required" class="form-control" placeholder="60xxxxxxx-x" pattern="(\d{9,9})*-(\d{1,1})" title="กรุณากรอกรหัสนักศึกษาให้ถูกต้อง" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="password" name="password" required="required" class="form-control" placeholder="abc12345" pattern="^(?=.*[a-z])(?=.*\d)[a-zA-Z\d]{8,}$" title="กรุณากรอกรหัสผ่านให้ถูกต้อง" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="phone" required="required" class="form-control" placeholder="0123456789" pattern="(\d{10,10})" title="กรุณากรอกเบอร์โทรศัพท์ให้ถูกต้อง" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
