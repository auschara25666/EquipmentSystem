...
if ($_SESSION['Role'] != "นักศึกษา") {
    echo "<script>alert('เข้าได้เฉพาะนักศึกษา');{document.location.href='http://10.199.66.227/SoftEn2020/Sec03/Perfect/EquipmentSystem/login.php'};</script>";
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">User-Home</h4>
                            <div class="row">
                                <div class="col-12">
